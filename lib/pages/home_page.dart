...
import 'package:offer_app/pages/offer_page.dart';
import 'package:offer_app/pages/qr_code.dart';
...
import 'package:offer_app/widgets/drawer.dart';
import 'package:offer_app/widgets/offer_widget.dart';
      ...
      case 0:
        {
          _pageController.animateToPage(
              0,duration:const Duration(milliseconds: 400),curve: Curves.easeIn);
          break;
        }
      case 1:
        {
          _pageController.animateToPage(
              1,duration:const Duration(milliseconds: 400),curve: Curves.easeIn);
          break;
        }
        case 2:
        {
          _pageController.animateToPage(
              2,duration:const Duration(milliseconds: 400),curve: Curves.easeIn);
          break;
        }
    }
  }
    ...
    return CustomScaffold(
      ...
      actions: [
       ...
       IconButton(onPressed: (){
         Go.to(context, const SettingPage(),behavior: NavigatorBehavior.downToTop);
